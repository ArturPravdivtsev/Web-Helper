    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                Profile
                <a href="/web_war/users/${user.id}/dialog" class="subscribe" style="float: right">Write message</a>
                ...
                <#if communities?has_content>
                    ...
                    <ul>
                        <#list communities as c>
                            <li>
                                <a href="/web_war/communities/${c.id}">${c.name}</a>
                            </li>
                        </#list>
                    </ul>
                    <hr>
...
<@main title="${user.name}" scripts=["/web_war/resources/custom/profile.js"]/>