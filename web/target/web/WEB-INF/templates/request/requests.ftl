            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    ...
                    <@sec.authorize access="hasRole('ROLE_ADMIN')">
                        <a href="/web_war/requests/pdf" target="_blank" style="float: right">generate pdf</a>
                    </@sec.authorize>
                    <@sec.authorize access="hasRole('ROLE_USER')">
                        <a href="/web_war/requests/new" style="float: right">New!</a>
                    </@sec.authorize>
                </div>
...
<@main title="Requests"
       ...
       scripts=["//cdn.datatables.net/1.10.11/js/jquery.dataTables.min.js",
                ...
                "/web_war/resources/custom/requests.js"]
/>